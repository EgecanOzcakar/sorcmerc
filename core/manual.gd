...
static func _mechanics() -> Array:
	...
	out.append({"id": "turn", "section": "Fighting", "title": "Your turn",
		...
		"[b]Reaction[/b] — one per round, and never a button: it fires by itself the moment something triggers it, on your turn or anyone else's. An opportunity attack when a foe walks out of your reach, Uncanny Dodge halving a hit, Hellish Rebuke burning whoever landed it, [b]Counterspell[/b] unravelling an enemy spell mid-cast (a CON save at DC 10 + the spell's level; it costs you the slot either way, and a countered caster keeps theirs). It comes back at the start of your turn.\n\n" +
