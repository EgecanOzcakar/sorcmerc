...
const GROUPS := [
	...
	{"id": "legend", "label": "Years in the Trade"},
...
const DEFS := [
	...
	{"id": "untouched", "group": "blood", "title": "Not a Scratch",
		"desc": "Win a fight without a single merc losing a hit point."},
	...
	{"id": "fumble_50", "group": "blood", "title": "Fifty Dropped Blades",
		"desc": "Roll 50 natural 1s.",
	...
	{"id": "all_down_win", "group": "blood", "title": "All Four Knees", "hidden": true,
		"desc": "Win a fight every single merc was knocked down in."},
	...
	{"id": "explosive", "group": "blood", "title": "Lamp Oil and a Spark", "hidden": true,
	...
	{"id": "resurrect_5", "group": "magic", "title": "Sent Back Five Times",
	...
	{"id": "level_20", "group": "legend", "title": "As Far as It Goes",
	...
	{"id": "big_spender", "group": "coin", "title": "Big Spender",
		"desc": "Spend 1,000 ◉ or more at merchants in a single run."},
	{"id": "gold_1000", "group": "coin", "title": "Purse Strings",
		"desc": "Have 1,000 ◉ at once.", "counter": "peak_gold", "goal": 1000},
	{"id": "gold_10000", "group": "coin", "title": "War Chest",
		"desc": "Have 10,000 ◉ at once.", "counter": "peak_gold", "goal": 10000},
	{"id": "gold_50000", "group": "coin", "title": "A Dragon's Problem",
		"desc": "Have 50,000 ◉ at once.", "counter": "peak_gold", "goal": 50000},
	{"id": "earned_100k", "group": "coin", "title": "The Wages of Adventure",
		"desc": "Earn 100,000 ◉ all told.", "counter": "gold_earned", "goal": 100000},
	{"id": "spent_25000", "group": "coin", "title": "Patron of Merchants",
		"desc": "Spend 25,000 ◉ all told.", "counter": "gold_spent", "goal": 25000},
	...
	{"id": "sell_500", "group": "coin", "title": "Fence",
		"desc": "Sell one item for 500 ◉ or more.", "counter": "best_sale", "goal": 500},
	...
	{"id": "known_first", "group": "road", "title": "Known Faces",
		"desc": "Be Known to a people.", "counter": "best_rung", "goal": 1},
	{"id": "sworn_first", "group": "road", "title": "Sworn",
		"desc": "Be Sworn to a people.", "counter": "best_rung", "goal": 3},
	{"id": "renown_famous", "group": "road", "title": "Asked For by Name",
		"desc": "Be spoken of across the map.", "counter": "renown_title", "goal": 3},
	{"id": "audience_first", "group": "road", "title": "An Audience",
		"desc": "Be received by a lord.", "counter": "audiences", "goal": 1},
	{"id": "calling_first", "group": "road", "title": "A Past",
		"desc": "See one of your people's callings through.", "counter": "callings", "goal": 1},
	{"id": "callings_4", "group": "road", "title": "Four Pasts",
		"desc": "See four callings through.", "counter": "callings", "goal": 4},
	# downtime (core/downtime.gd): the rows in town that take days
	{"id": "trained_first", "group": "road", "title": "Schooled",
		"desc": "Spend five days with a master-at-arms and come out with a feat.", "counter": "trained", "goal": 1},
	{"id": "carouse_contact", "group": "road", "title": "Friends in Low Places",
		"desc": "Make a contact on a night on the town.", "counter": "contacts", "goal": 1},
	{"id": "gamble_treble", "group": "road", "title": "The House Loses",
	...
	{"id": "saved_25", "group": "company", "title": "Bonesetter",
	...
	{"id": "one_species", "group": "company", "title": "Family Business", "hidden": true,
		"desc": "March out with four mercs of the same species."},
