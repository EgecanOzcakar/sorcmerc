...
(three gaps in the fight the design stands on) is, and so is the full-screen
moment every trait gained or lost will open (§8). Issue #176 asks for "character traits,
